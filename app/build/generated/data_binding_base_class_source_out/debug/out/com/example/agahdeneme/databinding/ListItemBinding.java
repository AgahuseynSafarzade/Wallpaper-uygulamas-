...
public final class ListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final RoundedImageView listImage;

  @NonNull
  public final ProgressBar progressBar;

  private ListItemBinding(@NonNull LinearLayout rootView, @NonNull RoundedImageView listImage,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.list_image;
      RoundedImageView listImage = ViewBindings.findChildViewById(rootView, id);
      if (listImage == null) {
        break missingId;
      }
      ...
      return new ListItemBinding((LinearLayout) rootView, listImage, progressBar);
    }
